...
format.pattern(1249.50, 'EUR #,##0.00'); // => "EUR 1,249.50"
...
format.currency(1249.50, 'USD', 'en-US'); // => "$1,249.50"
format.currency(1249.50, 'EUR', 'de-DE'); // => "1.249,50 €"

// Using custom options object
format.currency(1249.50, {
  currency: '€',
  position: 'suffix',
  decimal: ',',
  thousand: '.',
